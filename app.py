...
def initialize_data():
    if 'packing_list' not in st.session_state:
        st.session_state.packing_list = {
            "공연장 휴대용 배낭": {
                "[배면 포켓]": ["선크림", "맥주 너클 오프너", "모기 퇴치 스프레이"],
                "[사이드 포켓]": ["물병/텀블러"],
                "[내용물]": ["수건", "판초 우의 (파랑)", "플리스", "물티슈", "쿨링티슈", "이어플러그", "휴대폰 방수팩"],
            ...
            "당일 챙길 것": {
                ...
                "<카드 지갑>": ["건강보험증", "운전면허증", "신용카드"],
                "<티켓/기타>": ["주차권", "손목밴드 (입장권)", "타임테이블", "손수건", "집 열쇠", "차 열쇠", "애플워치", "애플워치 충전기/배터리", "멀티탭", "스킨/토너 (여행용)", "크림 (여행용)", "면도기 (여분)", "무선 이어폰", "카메라", "메모리카드"]
            },
            "당일 착용할 것": {
