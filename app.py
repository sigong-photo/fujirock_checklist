...
def initialize_data():
    if 'packing_list' not in st.session_state:
        st.session_state.packing_list = {
            ...
            "[캠핑/차박용] 야영 및 차량 보관": {
                "": ["에어매트", "미니 아이스박스", "접이식 우산", "돗자리", "손선풍기", "에어태그 (텐트 찾기용)"],
...
def generate_checklist_image():
    ...
    # Draw footer
    draw.text((width/2, height - 40), "만든이 @sigong © 2026 | Inspired by c86tori | v1.5.0", fill="#505060", font=font_subtitle, anchor="ms")
