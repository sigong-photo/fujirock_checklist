...
def generate_checklist_image():
    ...
    # Draw footer
    draw.text((width/2, height - 40), "만든이 @sigong © 2026 | Inspired by c86tori | v1.4.1", fill="#505060", font=font_subtitle, anchor="ms")
